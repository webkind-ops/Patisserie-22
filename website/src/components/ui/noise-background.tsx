...
export const NoiseBackground = ({
  ...
  containerClassName,
  gradientColors = [
    "rgba(167, 139, 250, 0.5)", // lavender-400
    "rgba(196, 181, 253, 0.5)", // lavender-200 
    "rgba(139, 92, 246, 0.5)",  // primary-lavender
  ],
  noiseIntensity = 0.2,
  speed = 0.1,
  backdropBlur = false,
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "group relative overflow-hidden rounded-full bg-lavender-50 p-2 backdrop-blur-sm",
        "shadow-soft-sm",
        backdropBlur &&
