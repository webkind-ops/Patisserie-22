      ...
      <div className="max-w-5xl mx-auto px-4 py-10 sm:px-6">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2 font-sans text-sm text-charcoal-muted">
              <a href={`tel:${store.phone.replace(/\s+/g, '')}`} className="flex items-center gap-2 hover:text-lavender-700 transition-colors w-fit p-2 -ml-2">
                <Phone className="w-4 h-4 text-lavender-600 shrink-0" />
                <span>{store.phone}</span>
              </a>
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-emerald-700 transition-colors w-fit p-2 -ml-2">
              ...
              <div className="flex gap-4 mt-2">
                <a href={store.instagramUrl} target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:text-pink-800 transition-colors p-3 -ml-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 font-sans text-sm font-medium text-lavender-800 hover:text-lavender-900 transition-colors mt-1 p-2 -ml-2"
              >
        ...
        <div className="mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-charcoal-muted tracking-tight relative z-10">
            <Link to="/terms" className="hover:text-lavender-700 transition-colors py-3 px-2">Terms & Conditions</Link>
            <span className="text-lavender-300 hidden sm:inline">|</span>
            <Link to="/privacy" className="hover:text-lavender-700 transition-colors py-3 px-2">Privacy Policy</Link>
          </div>
